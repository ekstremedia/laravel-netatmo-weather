...
it('can save a 48-character generated API token', function () {
    $station = NetatmoStation::create([
        'user_id' => 1,
        'station_name' => 'Test Station',
        'client_id' => 'test_client_id',
    ...
    // Simulate a token generated by the "Generate" button (48 characters)
    $generatedToken = 'aBcDeFgHiJkLmNoPqRsTuVwXyZ0123456789-_ABCDEFGH';
    ...
    $station->refresh();
    expect($station->api_enabled)->toBeTrue();
    expect($station->api_token)->toBe($generatedToken);
});

it('can remove API token to make endpoints public', function () {
    $station = NetatmoStation::create([
        'user_id' => 1,
        'station_name' => 'Test Station',
        'client_id' => 'test_client_id',
    ...
    expect($station->api_token)->not->toBeNull();
    ...
    $station->refresh();
    expect($station->api_enabled)->toBeTrue();
    expect($station->api_token)->toBeNull();
});

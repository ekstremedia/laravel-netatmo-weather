...
<div class="bg-gradient-to-br from-dark-elevated/90 to-dark-elevated/70 backdrop-blur-xl rounded-3xl shadow-2xl shadow-cyan-900/20 border border-cyan-500/20 overflow-hidden">

    {{-- Header with Status --}}
    <div class="bg-gradient-to-r from-cyan-500/20 via-blue-500/20 to-teal-500/20 px-6 py-4 border-b border-cyan-500/30">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    @if($module->dashboard_data)
                        <p class="text-sm text-cyan-200/70 flex items-center mt-1">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div class="bg-gradient-to-br from-orange-500/10 to-amber-500/10 rounded-2xl p-4 border border-orange-500/20"
                    ...
                    <div class="flex items-center justify-between text-xs gap-2">
                        ...
                        <span class="text-orange-200/50 text-[10px]">24h range</span>

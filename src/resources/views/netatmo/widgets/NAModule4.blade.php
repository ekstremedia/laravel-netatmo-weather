<div class="flex flex-col items-center gap-y-4 p-6 bg-white shadow-lg rounded-lg w-full from-purple-100 to-pink-100 bg-gradient-to-tl">
    <div class="flex items-center justify-center gap-x-4 mb-4">
        <img src="{{ asset('netatmo-weather/images/icons/indoor.svg') }}" alt="Indoor Module Logo" width="50"
             class="mr-4">
        <div class="flex flex-col items-center">
            ...
            @endif
            <small class="text-gray-500">Last seen: @datetime($module->last_seen)</small></div>
    </div>
    @if($module->dashboard_data)

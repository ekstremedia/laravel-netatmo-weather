...
<div class="bg-dark-elevated/80 backdrop-blur-xl rounded-2xl shadow-2xl shadow-purple-900/20 border border-dark-border/50 p-6">
    ...
    <div class="flex items-center justify-between mb-6 pb-4 border-b border-dark-border/50">
        <div class="flex items-center space-x-4">
            <div class="bg-gradient-to-br from-violet-500 via-purple-500 to-fuchsia-500 p-3 rounded-xl shadow-lg shadow-violet-900/30">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div class="bg-dark-surface/40 rounded-xl p-4 border border-dark-border/30">
                <div class="flex items-center space-x-2 mb-2">
                    ...
                    <span class="text-sm text-purple-300">CO2 Level</span>
                </div>
            ...
            <div class="bg-dark-surface/40 rounded-xl p-4 border border-dark-border/30">
                <div class="flex items-center space-x-2 mb-2">
                    ...
                    <span class="text-sm text-purple-300">Temperature Trend</span>
                </div>
                <div class="text-xl font-bold text-white">{{ $module->dashboard_data['temp_trend'] }}</div>
            </div>
        </div>
    @else
